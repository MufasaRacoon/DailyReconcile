...
<head>
    ...
    <title>Chocolat Tank 2 - Smart Factory</title>
...
<!-- NAVBAR -->
    ...
    <div class="glass-container">
        <header style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 15px;">
            <h1>CHOCOLAT TANK 2</h1>
            <button class="btn accent" onclick="location.href='index.php'" style="width: auto;" >Back to menu</button>
        </header>
    
<!-- IF PAS DE BATCH DANS CHOCOLAT TANK 2 -->
<?php if (!$hasStock) {  ?>
        <main>
            <div class="stock-display">
                <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Chocolat Tank 2</label>
...
<!-- S'IL Y A DE BACTH EN COURS DANS CHOCOLAT TANK 2 -->
<?php } else { ?>
        <main>
            <div class="stock-display">
                <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Chocolat Tank 2</label>
            ...
            <?php if ($data['status'] == 'STARTED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/chocolatTank2/conche_loading.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Chargement</button>
            <?php } else if($data['status'] == 'FINISHED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/chocolatTank2/chocolat_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
            <?php } else { ?>
                <button class="btn accent" onclick="location.href='metier/chocolatTank2/chocolat_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
               <?php }?>
        </main>
