...
$ofList = $controller_buffer_tank->getSelectableOF($controller_buffer_tank->getIdBufferTank2());
...
$dataBufferTank1 = $controller_buffer_tank->getEquipment($controller_buffer_tank->getIdBufferTank1());
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if ($result === true){
        header('Location: ../../buffer_tank_2.php');
        exit;
    } else {
        $error = $result;
    }
...
<head>
    ...
    <title>Transfert Depuis Buffer Tank 2</title>
    <style>
        :root {
...
<body>
    ...
    <div class="glass-container">
        <header style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 15px;">
            <h1>TRANSFERT DEPUIS Buffer Tank 2</h1>
            <button class="btn accent" onclick="location.href='../../buffer_tank_2.php'" style="width: auto;">Annuler</button>
        ...
        <main>
            ...
            <form id="transferForm" action="buffer_tank_transfert.php?id=<?= (int)$data['id'] ?>" method="post" class="section-card" style="border-left: 5px solid var(--accent);">
                ...
                <div class="stock-display">
                    <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Buffer Tank 2</label>
                ...
                <div class="grid-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="destination" id="selectDestination" required>
                            ...
                            <option value="<?= htmlspecialchars($controller_buffer_tank->getIdBufferTank1()) ?>">Buffer Tank 1 - <?= htmlspecialchars((string)$dataBufferTank1['current_qty_kg']) ?> Kg / <?= htmlspecialchars((string)$dataBufferTank1['capacity_kg']) ?> Kg</option>
