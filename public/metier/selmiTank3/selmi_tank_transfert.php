...
$data = $controller_selmi_tank->get_batch($controller_selmi_tank->getIdSelmiTank3());
$ofList = $controller_selmi_tank->getSelectableOF($controller_selmi_tank->getIdSelmiTank3());
...
<head>
    ...
    <title>Transfert Depuis Selmi Tank 3</title>
    <style>
        :root {
...
<body>
    ...
    <div class="glass-container">
        <header style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 15px;">
            <h1>TRANSFERT DEPUIS Selmi Tank 3</h1>
            <button class="btn accent" onclick="location.href='../../selmi_tank_3.php'" style="width: auto;">Annuler</button>
        ...
        <main>
            ...
            <form id="transferForm" action="selmi_tank_transfert.php?id=<?= (int)$data['id'] ?>" method="post" class="section-card" style="border-left: 5px solid var(--accent);">
                ...
                <div class="stock-display">
                    <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Selmi Tank 3</label>
