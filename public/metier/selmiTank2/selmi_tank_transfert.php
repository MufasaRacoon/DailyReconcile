...
$data = $controller_selmi_tank->get_batch($controller_selmi_tank->getIdSelmiTank2());
$ofList = $controller_selmi_tank->getSelectableOF($controller_selmi_tank->getIdSelmiTank2());
...
$dataSelmiTank1 = $controller_selmi_tank->getEquipment($controller_selmi_tank->getIdSelmiTank1());
...
<head>
    ...
    <title>Transfert Depuis Selmi Tank 2</title>
    <style>
        :root {
...
<body>
    ...
    <div class="glass-container">
        <header style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 15px;">
            <h1>TRANSFERT DEPUIS Selmi Tank 2</h1>
            <button class="btn accent" onclick="location.href='../../selmi_tank_2.php'" style="width: auto;">Annuler</button>
        ...
        <main>
            ...
            <form id="transferForm" action="selmi_tank_transfert.php?id=<?= (int)$data['id'] ?>" method="post" class="section-card" style="border-left: 5px solid var(--accent);">
                ...
                <div class="stock-display">
                    <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Selmi Tank 2</label>
