...
$ofList = $controller_conche->getSelectableOF($controller_conche->getIdConche2());
...
$dataConche1 = $controller_conche->getEquipment($controller_conche->getIdConche1());
...
<head>
    ...
    <title>Transfert Depuis Conche 2</title>
    <style>
        :root {
...
<body>
    ...
    <div class="glass-container">
        <header style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 15px;">
            <h1>TRANSFERT DEPUIS Conche 2</h1>
        ...
        <main>
            ...
            <form id="transferForm" action="conche_transfert.php?id=<?= (int)$data['id'] ?>" method="post" class="section-card" style="border-left: 5px solid var(--accent);">
                ...
                <div class="stock-display">
                    <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Conche 2</label>
                ...
                <div class="grid-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="destination" id="selectDestination" required>
                            ...
                            <option value="<?= htmlspecialchars($controller_conche->getIdConche1()) ?>">Conche 1 - <?= htmlspecialchars((string)$dataConche1['current_qty_kg']) ?> Kg / <?= htmlspecialchars((string)$dataConche1['capacity_kg']) ?> Kg</option>
                        </select>
                    </div>
                </div>
