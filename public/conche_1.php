...
<!-- S'IL Y A DE BACTH EN COURS DANS Conche 1 -->
<?php } else { ?>
        <main>
            <div class="stock-display">
                <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Conche</label>
                ...
                <label style="color: rgba(255,255,255,0.6);">Etat du Conche 1 :</label>
            ...
            <?php if ($data['status_load'] == 'LOADING' && $data['status'] == 'LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/conche1/conche_loading.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Chargement</button>
                <button class="btn accent" onclick="location.href='metier/conche1/details.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Voir details des chargements</button>
            <?php } else if($data['status_load'] == 'LOADING' && ($data['status'] == 'FINISHED_LOADING')) { ?>
                <button class="btn accent" onclick="location.href='metier/conche1/conche_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
                <button class="btn accent" onclick="location.href='metier/conche1/conche_details.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Voir details des chargements</button>
