...
$data = $controller_chocolat_tank->get_batch($controller_chocolat_tank->getIdChocoTank1());
...
<head>
    ...
    <title>Chocolat Tank 1 - Smart Factory</title>
...
<!-- S'IL Y A DE BACTH EN COURS DANS CHOCOLAT TANK 1 -->
<?php } else { ?>
        <main>
            <div class="stock-display">
                <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Chocolat Tank 1</label>
            ...
            <?php if ($data['status'] == 'STARTED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/chocolatTank1/conche_loading.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Chargement</button>
            <?php } else if($data['status'] == 'FINISHED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/chocolatTank1/chocolat_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
            <?php } else { ?>
                <button class="btn accent" onclick="location.href='metier/chocolatTank1/chocolat_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
               <?php }?>
        </main>
