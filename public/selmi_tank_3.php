...
<head>
    ...
    <title>Selmi Tank 3 - Smart Factory</title>
...
<!-- IF PAS DE BATCH DANS Selmi TANK 3 -->
<?php if (!$hasStock) {  ?>
        <main>
...
<!-- S'IL Y A DE BACTH EN COURS DANS Selmi TANK 23-->
<?php } else { ?>
        <main>
            <div class="stock-display">
                <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Selmi Tank 3</label>
            ...
            <?php if ($data['status'] == 'STARTED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/selmiTank3/conche_loading.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Chargement</button>
            <?php } else if($data['status'] == 'FINISHED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/selmiTank3/selmi_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
            <?php } else { ?>
                <button class="btn accent" onclick="location.href='metier/selmiTank3/selmi_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
               <?php }?>
        </main>
