...
<head>
    ...
    <title>Buffer Tank 1 - Smart Factory</title>
...
<!-- IF PAS DE BATCH DANS Buffer TANK 1 -->
<?php if (!$hasStock) {  ?>
        <main>
...
<!-- S'IL Y A DE BACTH EN COURS DANS Buffer TANK 1 -->
<?php } else { ?>
        <main>
            <div class="stock-display">
                <label style="color: rgba(255,255,255,0.6);">Stock Actuel en Buffer Tank 1</label>
            ...
            <?php if ($data['status'] == 'STARTED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/BufferTank1/conche_loading.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Chargement</button>
            <?php } else if($data['status'] == 'FINISHED_LOADING') { ?>
                <button class="btn accent" onclick="location.href='metier/BufferTank1/Buffer_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
            <?php } else { ?>
                <button class="btn accent" onclick="location.href='metier/BufferTank1/Buffer_tank_transfert.php?id=<?= (int)$data['id'] ?>'" style="margin-top:20px;">Lancer le transfert</button>
               <?php }?>
        </main>
